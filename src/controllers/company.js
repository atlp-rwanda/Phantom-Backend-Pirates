...
class Companies {
  ...
  static create(req, res) {
    ...
    return helper
      .checkPermission(req.user.user.roleId, 'create company')
      .then((rolepermission) => {
        if (rolepermission) {
          Company.create({
            name,
  ...
  static modify(req, res) {
    ...
    return helper
      .checkPermission(req.user.user.roleId, 'update company')
      .then((rolepermission) => {
        if (rolepermission) {
  ...
  static delete(req, res) {
    ...
    return helper
      .checkPermission(req.user.user.roleId, 'delete company')
      .then((rolepermission) => {
        if (rolepermission) {
          Company.findByPk(req.params.id)
            .then((company) => {

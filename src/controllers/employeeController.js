...
class Employees {
  static create(req, res) {
    ...
    return helper
      .checkPermission(req.user.user.roleId, 'create employee')
      .then((rolepermission) => {
        if (rolepermission) {
          Employee.create({
            firstname,
  ...
  static updateEmployee(req, res) {
    ...
    return helper
      .checkPermission(req.user.user.roleId, 'update employee')
      .then((rolepermission) => {
        if (rolepermission) {
              ...
              employee
                ...
                .then((updatedEmployee) => {
                  res.status(200).send({
                    ...
                    data: {
                      firstname:
                        firstname || updatedEmployee.employee.firstname,
  ...
  static delete(req, res) {
    ...
    return helper
      .checkPermission(req.user.user.roleId, 'delete employee')
      .then((rolepermission) => {
        if (rolepermission) {
          Employee.findByPk(req.params.id)
            .then((Employee) => {
